...
void init_timer1a(uint8_t prescaler) {
	...
	TIMER1_CFG_R = 0x04; // 16-bit mode, count up to 2^16 -> maximum delay (with 16 MHz clock) of
						 // 65536/16000000 = 4.096 ms (16 mhz clock signal, page 58 in datasheet)
	TIMER1_TAMR_R = 0x02;       // 3 modes: one-shot, periodic and capture
	...
	NVIC_EN0_R |= (1 << 21); // Shifts 00000....1 (32 bits in total) 21 times to the left
							 // setting the 21 bit for enabling timer1a interrupt (its interrupt vector is 21)
